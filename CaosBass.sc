...
CaosBass {
	...
	*robot {|att = 0.1, rel = 0.5, note = 220, filtminf = 60, filtmaxf = 2600, filtime = 0.2, rq = 0.5,  iphase = 0.25, amp1 = 1, amp2 = 1, t = 1, tp = 0|
		var bass,env,filtro;
		bass=SinOsc.ar(note,0,amp1/2)+LFSaw.ar(note,iphase,amp2/4);
		filtro=RLPF.ar(bass,XLine.kr(filtminf,filtmaxf,filtime),rq);
